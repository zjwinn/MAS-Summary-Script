...
fwrite(as.data.table(hapmap, keep.rownames = FALSE), 
       file = paste(output_directory, "/", strsplit(vcf_file, "\\.")[[1]][1], "_hapmap.hmp.txt.gz", sep = ""),
       sep = "\t")
...
write.csv(marker_report,
          paste(output_directory, "/", strsplit(vcf_file, "\\.")[[1]][1], "_Marker_Report_Full.csv", sep = ""),
          row.names = FALSE,
          quote = TRUE)
...
write.csv(marker_summary,
          paste(output_directory, "/", strsplit(vcf_file, "\\.")[[1]][1], "_Marker_Report_Summary.csv", sep = ""),
          row.names = FALSE,
          quote = TRUE)
...
if(!is.null(missing_haplotypes)){
  ...
  write.csv(missing_haplotypes,
            paste(output_directory, "/", strsplit(vcf_file, "\\.")[[1]][1], "_Unidentified_Haplotypes.csv", sep = ""),
            row.names = FALSE,
            quote = TRUE)  
...
if(!is.null(auto_suggestions)){
  ...
  write.csv(auto_suggestions,
            paste(output_directory, "/", strsplit(vcf_file, "\\.")[[1]][1], "_Auto_Suggested_Haplotypes.csv", sep = ""),
            row.names = FALSE,
            quote = TRUE)  
